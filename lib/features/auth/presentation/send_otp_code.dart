...
import 'package:pile_up/features/auth/presentation/pin_text_field.dart';

class SendOTPCode extends StatefulWidget {
  const SendOTPCode({super.key, required this.phoneNumber});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context,
          text: StringManager.confirmPhoneNumber.tr(), isIcon: false),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              StringManager.pleaseEnterYOurCode('0${widget.phoneNumber}'),
              maxLines: 4,
              style: TextStyle(
